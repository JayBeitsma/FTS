                ...
                <li class="bg-white shadow-lg rounded-lg overflow-hidden">
                    <details class="p-6">
                        <summary class="flex justify-between items-center cursor-pointer space-x-4">
                            ...
                            <div>
                                <h2 class="text-2xl font-bold">{{ $busride->name }}</h2>
                                <p class="text-gray-600">{{ $busride->description }}</p>
                            </div>
                        ...
                        <div class="mt-4 border-t border-gray-200 pt-4">
                            ...
                            <a href="#" class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-md">Buy Tickets</a>
                        </div>
                    </details>
                </li>
            @endforeach
