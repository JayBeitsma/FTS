        ...
        <form action="{{ isset($busride) ? route('admin.dashboard.busrides.update', $busride->id) : route('admin.dashboard.busrides.create') }}" method="POST" class="flex flex-col w-4/5 space-y-4">
            ...
            <div class="flex flex-row justify-between md:flex-row space-x-4">
                <div class="w-full">
                    ...
                    <input type="text" name="name" value="{{ $busride->name ?? '' }}" placeholder="Naam" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
                <div class="w-full">
            ...
            <div class="flex flex-row justify-between md:flex-row space-x-4">
                <div class="w-full">
                    ...
                    <input type="text" name="festival_name" value="{{ $busride->festival_name ?? '' }}" placeholder="Festival naam" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
                <div class="w-full">
                    <h3 class="text-lg font-bold">Beschrijving</h3>
                    <textarea name="description" placeholder="Beschrijving" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>{{ $busride->description ?? '' }}</textarea>
                </div>
            </div>
            <div class="flex flex-row justify-between md:flex-row space-x-4">
                <div class="w-full">
                    <h3 class="text-lg font-bold">Startpunt</h3>
                    <input type="text" name="starting_point" value="{{ $busride->starting_point ?? '' }}" placeholder="Startpunt" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
                <div class="w-full">
                    <h3 class="text-lg font-bold">Eindpunt</h3>
                    <input type="text" name="end_point" value="{{ $busride->end_point ?? '' }}" placeholder="Eindpunt" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
            </div>
            <div class="flex flex-row justify-between md:flex-row space-x-4">
                <div class="w-full">
                    <h3 class="text-lg font-bold">Datum van vertrek</h3>
                    <input type="date" name="departure_date" value="{{ $busride->departure_date ?? '' }}" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
                <div class="w-full">
                    <h3 class="text-lg font-bold">Tijd van vertrek</h3>
                    <input type="time" name="departure_time" value="{{ $busride->departure_time ?? '' }}" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
            </div>
            <div class="flex flex-row justify-between md:flex-row space-x-4">
                <div class="w-full">
                    <h3 class="text-lg font-bold">Datum van aankomst</h3>
                    <input type="date" name="arrival_date" value="{{ $busride->arrival_date ?? '' }}" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
                <div class="w-full">
                    <h3 class="text-lg font-bold">Tijd van aankomst</h3>
                    <input type="time" name="arrival_time" value="{{ $busride->arrival_time ?? '' }}" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
            </div>
            <div class="flex flex-row justify-between md:flex-row space-x-4">
                <div class="w-full">
                    <h3 class="text-lg font-bold">Aantal tickets</h3>
                    <input type="number" name="tickets_available" value="{{ $busride->tickets_available ?? '' }}" placeholder="Aantal tickets" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
                <div class="w-full">
                    <h3 class="text-lg font-bold">Prijs</h3>
                    <input type="number" name="price" value="{{ $busride->price ?? '' }}" placeholder="Prijs" class="border border-gray-300 rounded-lg p-2 w-full text-black" required>
                </div>
            </div>
